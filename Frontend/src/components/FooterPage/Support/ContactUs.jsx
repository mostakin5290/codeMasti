                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className={`${appTheme.cardBg}/5 backdrop-blur-lg rounded-xl border ${appTheme.border}/20 p-8 shadow-lg`}>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className={`w-full flex items-center justify-center gap-2 px-8 py-3 rounded-lg ${getPrimaryGradientClasses()} ${appTheme.buttonText} font-medium hover:shadow-lg ${getPrimaryHoverShadowClass()} transition-all transform hover:scale-[1.02]`}
                            >
